      ...
      <div className='flex flex-wrap justify-center mt-10'>
        {
          testimonials.map((testimonial, index) => (
            <div key={index} className='w-full sm:w-1/2 lg:w-1/3 px-4 py-2'>
              <div className='dark:bg-neutral-900 light:bg-white rounded-md p-6 text-md border border-neutral-800 dark:font-thin light:font-normal dark:text-neutral-300 text-black
              '>
